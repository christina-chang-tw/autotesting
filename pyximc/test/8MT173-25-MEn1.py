...
def set_profile_8MT173_25_MEn1(lib, id):
    ...
    class LimitSwitchesSettings_(Enum):
        LS_SHORTED = 16
        LS_SW2_ACTIVE_LOW = 8
        LS_SW1_ACTIVE_LOW = 4

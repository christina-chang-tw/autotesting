...
This module contains the algorithms used by different parts of the system.
"""
import numpy as np
...
def op_algorithm(
    ...
    ----------
    theta_r : float
        The desired rotor position (rad),
...
def calc_rotor_flux_linkage(
    ...
    ----------
    k : float
        This can either be the motor's electromechnical coefficient (km)
        or the counter-EMF coefficient (kemf).
    n : int
